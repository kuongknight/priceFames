...
/**
 * The base model interface for the Foo service. Represents a row in the &quot;priceFames_Foo&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.mtt.liferay.model.impl.FooModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.mtt.liferay.model.impl.FooImpl}.
 * </p>
 *
...
public interface FooModel extends BaseModel<Foo>, StagedGroupedModel {
    ...
    @Override
    public CacheModel<com.mtt.liferay.model.Foo> toCacheModel();
