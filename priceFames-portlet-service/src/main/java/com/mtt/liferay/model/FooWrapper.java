...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
    ...
    */
    ...
    @Override
    public int compareTo(com.mtt.liferay.model.Foo foo) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<com.mtt.liferay.model.Foo> toCacheModel() {
        return _foo.toCacheModel();
    }

    @Override
    public com.mtt.liferay.model.Foo toEscapedModel() {
        return new FooWrapper(_foo.toEscapedModel());
    }

    @Override
    public com.mtt.liferay.model.Foo toUnescapedModel() {
